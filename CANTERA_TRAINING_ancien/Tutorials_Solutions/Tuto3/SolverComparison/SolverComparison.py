...
# time comparison between different solvers 
#              
###############################################################
...
temperature = 1000.0  # unburned gas temperature
...
#################################################################
# Equilibrium:
# gas.equilibrate('TP', solver = 'element_potential', maxsteps = 1500)  # use the ChemEquil solver
gas.equilibrate('TP', solver='vcs', maxsteps=1500)  # use the vcs solver
# gas.equilibrate('TP', solver = 'gibbs', maxsteps = 1500)              # use the gibbs solver
